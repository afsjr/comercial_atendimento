    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-zinc-500 text-sm">Gerencie sua base de contatos e prospecções</p>
        </div>
        <button
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-zinc-200">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-zinc-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
          />
        </div>
      </div>
